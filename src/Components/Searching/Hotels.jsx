  ...
  return (
    <>
      <div className="fixed z-[2] items-center bg-white max-w-5xl px-3 py-6 rounded-md justify-center shadow-2xl lg:relative lg:top-0">
        {/* triangle */}
        <span className='hidden absolute left-[16rem] bg-white -top-2.5 h-5 w-5 lg:inline-block' style={{ clipPath: 'polygon(50% 0%, 0% 100%, 100% 100%)' }}></span>
        ...
        <span className='grid grid-cols-1 px-8 items-start gap-y-10 justify-center lg:grid-cols-4'>
